...
const Location = ({ location }) => {
  return (
    <>
      ...
      <input className="p-1 outline-none bg-black text-gray-400 placeholder:text-center" type="text" name="location" placeholder="Type a location id..."/>
      ...
      <div>
        {
          location?.residents.map((resident, index)=>(
            <ResidentCard residentLocation={resident} key={index}
          />))
        }
